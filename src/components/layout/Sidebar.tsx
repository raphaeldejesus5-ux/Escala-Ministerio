...
const navItems = [
  ...
  { href: '/escala/sugestao',    label: 'Sugestão IA',    icon: Sparkles },
  { href: '/integrantes',        label: 'Integrantes',    icon: Users },
  { href: '/trocas',             label: 'Trocas',         icon: ArrowLeftRight },
  { href: '/indisponibilidade',  label: 'Indisponível',   icon: CalendarX },
    ...
    <aside className="hidden md:flex flex-col w-56 min-h-screen bg-brand-dark border-r border-white/10">
      ...
      <div className="flex items-center gap-2.5 px-4 py-5 border-b border-white/10">
        ...
        <div>
          ...
          <p className="text-xs text-white/50 leading-tight">Ministério</p>
        </div>
      </div>
